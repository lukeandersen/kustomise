					...
					<div id="main" class="eightcol left first clearfix" role="main">
						...
						<article id="post-<?php the_ID(); ?>" <?php post_class('clearfix'); ?>>
      						...
      						<section class="post_content clearfix">
      							<p class="attachment text-center"><a href="<?php echo wp_get_attachment_url($post->ID); ?>"><?php echo wp_get_attachment_image( $post->ID, 'large' ); ?></a></p>
      						...
      						<footer>
								<nav class="prev-next-links">
									<ul class="clearfix post_content">
        								<li class="left"><?php previous_image_link() ?></li>
        								<li class="right"><?php next_image_link() ?></li>
        							</ul>
      							</nav>
      						</footer>
    					</article>
